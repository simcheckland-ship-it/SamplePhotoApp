        ...
        <>
            ...
            <header className="h-16 border-b border-slate-800 bg-slate-900/50 backdrop-blur-md flex items-center justify-between px-6 z-10">
                <div className="flex flex-col space-x-3">
                    ...
                    <span className="text-xl font-semibold tracking-tight text-white">The Breakfast App</span>
                    <span className="text-xs  ml-2 text-slate-300 font-mono">The most important demo app of the day...</span>
                </div>

                <div className="flex items-center space-x-4 text-sm text-slate-400">
                    <Link className="px-3 py-1.5 rounded-md hover:bg-slate-800 transition" to="/">Home</Link>
                    <Link className="px-3 py-1.5 rounded-md hover:bg-slate-800 transition" to="/image">Images</Link>
                    <Link className="px-3 py-1.5 rounded-md hover:bg-slate-800 transition" to="/map">Map</Link>
                    <Link className="px-3 py-1.5 rounded-md hover:bg-slate-800 transition" to="/about">About</Link>
